...
public class InvoiceDao {
	...
	public static String insertInvoice(String invoiceno,String pono,String  sdate,String  taxvalue,String  total) {
		String status = "";
		try {
			Connection con = DbConnect.getConnection();
			String uuid = UuidGenerator.createUUID();
			String query = "insert into invoice(uuid,invoiceno,pono,sdate,taxvalue,total) values('"
					+ uuid
					+ "','"
					+ invoiceno
					+ "','"
