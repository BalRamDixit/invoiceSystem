...
<%
	...
	if("list".equals(action))
	{
		...
		int recordCount =DbAction.get_clients_count();
		ResultSet rs=DbAction.get_clients(var1,var2,var3);
	...
	else if("create".equals(action))
	{
		...
		boolean status=DbAction.insertclient(clientname,companyname,contectno,email,address,city,url);
	...
	else if("update".equals(action))
	{
		...
		String city=request.getParameter("city");
		String url=request.getParameter("url");
		boolean status = DbAction.updateclient(uuid,clientname,companyname,contectno,email,address,city,url);
